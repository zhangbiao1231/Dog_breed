...
_C.DATASETS.DATA_DIR =  str(ROOT) + '/data/datasets/train_valid_test'
_C.DATASETS.TRAIN = ()
# List of the dataset names for testing, as present in paths_catalog.py
_C.DATASETS.TEST = ()
_C.DATASETS.IMAGENET_MEAN = [0.485, 0.456, 0.406]
_C.DATASETS.IMAGENET_STD = [0.229, 0.224, 0.225]
_C.DATASETS.SCALE = (0.08, 1.0)
_C.DATASETS.RATIO = (0.75, 1.0 / 0.75) # 0.75, 1.33
_C.DATASETS.JITTER = 0.4
